...
source("src/data_preprocessing/mosaicking_helpers.R")
...
mosaic_raster(
  config = config,
  year = year,
  output_folder = "Mosaic_Buildings_",
  raster_type = "Buildings"
)
...
mosaic_raster(
  config = config,
  year = year,
  output_folder = "Mosaic_Covariates_",
  raster_type = "Covariates",
